...
---
### 🧠 About Me
- 🤖 **AI Agent Developer**: LangGraph와 Ollama를 활용한 지능형 에이전트 구축에 열정을 가지고 있습니다.
- 📱 **Cross-Platform**: Flutter를 이용한 실용적이고 아름다운 UI/UX 구현을 지향합니다.
- 🚀 **Problem Solver**: 복잡한 문제를 단순화하고 효율적인 아키텍처로 해결하는 과정에서 즐거움을 찾습니다.
- 📈 **Continuous Learner**: 매일 새로운 논문과 기술 문서를 탐독하며 역량을 확장하고 있습니다.
---
### 🛠 Tech Stack
<div align="center">
...
| **Frontend** | <img src="https://img.shields.io/badge/Flutter-02569B?style=flat&logo=flutter&logoColor=white" /> <img src="https://img.shields.io/badge/React-20232A?style=flat&logo=react&logoColor=61DAFB" /> <img src="https://img.shields.io/badge/Next.js-000000?style=flat&logo=nextdotjs&logoColor=white" /> |
| **Tools** | <img src="https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white" /> <img src="https://img.shields.io/badge/Git-F05032?style=flat&logo=git&logoColor=white" /> <img src="https://img.shields.io/badge/Linux-FCC624?style=flat&logo=linux&logoColor=black" /> <img src="https://img.shields.io/badge/VS_Code-007ACC?style=flat&logo=visualstudiocode&logoColor=white" /> |
</div>
---
### 🌟 Featured Work
#### 🤖 [AI Assistant Agent](https://github.com/kc9302/AI_Assistant)
> **LangGraph 기반 자율형 지능 비서**  
> Google Calendar, RAG, 하이브리드 메모리 시스템이 통합된 차세대 에이전트입니다.
- **핵심 성취**: 복잡한 의사결정 트리를 LangGraph로 구조화하여 도구 호출 정확도 95% 이상 달성.
- **기술적 도전**: 대용량 세션 데이터의 SQLite 영속성 최적화 및 사용자 프로필 자동 추출 로직 구현.
---
### 📊 GitHub Activity
<p align="center">
